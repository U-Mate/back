...
✅ ** 필수 사항 **
- 반드시 Markdown 형식으로 다듬어서(줄바꿈, 간격, 이모티콘 사용 등) 색감있고 화려하게 답변할 것
...
**핵심 차이점 분석**:
• 데이터 사용량별 적합성 (1GB vs 3GB vs 5GB vs 무제한)
• 통화 패턴별 최적화 (100분 vs 300분 vs 무제한)
• 부가서비스 포함 여부 (OTT, 음악, 실버지킴이 등)
• 연령대별 할인 혜택 적용 여부

**비용 효율성 분석**:
• GB당 단가 계산 (월 요금 ÷ 데이터 용량)
• 분당 통화 단가 계산 (월 요금 ÷ 통화 시간)
• 부가서비스 포함 시 실제 절약 금액
...
요금제 비교 시 핵심 차이점만 간단명료하게 보여드리겠습니다!

📊 **요금제 비교 예시**:

**요금제A vs 요금제B vs 요금제C**

💰 **월 요금**: 30,000원 vs 45,000원 vs 60,000원
📱 **데이터**: 3GB vs 5GB vs 무제한
📞 **통화**: 300분 vs 500분 vs 무제한
💡 **GB당 단가**: 10,000원 vs 9,000원 vs -
👥 **추천 연령**: 20-30대 vs 30-40대 vs 모든 연령
🎬 **부가서비스**: OTT 1개 vs OTT 2개 vs OTT 3개

✅ **추천**: 데이터 적게 쓰시면 A, 중간이면 B, 많이 쓰시면 C가 유리해요!

이런 식으로 구체적인 비교 분석을 제공!
            ...
            openaiWs.send(
              JSON.stringify({
                ...
                response: {
                  ...
                  instructions:
                    'UMate 통신 서비스 관련 질문에만 답변하세요. 그리고 당신은 응답을 반드시 Markdown 문법으로만 작성해야 합니다. 무관한 주제는 "죄송합니다. UMate 서비스 관련 질문만 답변드립니다"라고 음성과 텍스트로 응답하세요.',
                },
              })
            );
          }
...
💰 **월 요금**: 30,000원 vs 45,000원
📱 **데이터**: 3GB vs 5GB
📞 **통화**: 300분 vs 500분
💡 **GB당 단가**: 10,000원 vs 9,000원
👥 **추천 연령**: 20-30대 vs 30-40대
🎬 **부가서비스**: OTT 1개 vs OTT 2개
...
**추가 비교 (4개 요금제)**:
**요금제A vs 요금제B vs 요금제C vs 요금제D**

💰 **월 요금**: 30,000원 vs 45,000원 vs 60,000원 vs 80,000원
📱 **데이터**: 3GB vs 5GB vs 무제한 vs 무제한
📞 **통화**: 300분 vs 500분 vs 무제한 vs 무제한
💡 **GB당 단가**: 10,000원 vs 9,000원 vs - vs -
👥 **추천 연령**: 20-30대 vs 30-40대 vs 모든 연령 vs 모든 연령
🎬 **부가서비스**: OTT 1개 vs OTT 2개 vs OTT 3개 vs OTT 4개

✅ **추천**: 
- 데이터 적게 쓰시면 A, 중간이면 B, 많이 쓰시면 C, 프리미엄이면 D가 유리해요!
- 비교하고 싶은 요금제가 더 있으시면 언제든 말씀해 주세요!

이런 식으로 2개부터 시작해서 필요에 따라 확장 가능한 비교 분석을 제공!
